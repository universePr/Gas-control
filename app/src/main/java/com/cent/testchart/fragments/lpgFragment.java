...
public class lpgFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_lpg, container, false);
    }
    private void init_() {
    ...
    private void Any_Chart_co2() {
        anyChartView =  (AnyChartView) container.findViewById(R.id.any_chart_view_lpg);
        hidden_v = container.findViewById(R.id.hidden_v);
        card = container.findViewById(R.id.card_chart_lpg);
